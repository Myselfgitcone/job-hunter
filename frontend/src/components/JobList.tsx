...
interface Props {
  ...
  checkedIds?: Set<string>;              // multi-select for batch tailoring
  onToggleCheck?: (id: string) => void;
  onDefer?: (id: string, deferred: boolean) => void;
}

export function JobList({ jobs, selectedId, onSelect, onSkip, onUpdate, onQualifyUpdated, emptyState, mode = "compact", tailorRuns = {}, checkedIds, onToggleCheck, onDefer }: Props) {
